...
export const movieTicket = require('./../assets/icons/movie-tickets.png');
export const speechBubble = require('./../assets/icons/speech-bubble.png');
export const box = require('./../assets/icons/box.png');
export const bill = require('./../assets/icons/bill.png');
export const faceID = require('./../assets/icons/faceID_icon.png');
